...
class Account {
    ...
    private function addHistorico ($intAccId, $blnEliminada) {
        ...
        $strQuery .= "'".$this->dbh->real_escape_string($objAccountHist->strAccCliente)."', ";
        $strQuery .= "$objAccountHist->intAccCategoryId, ";
        $strQuery .= "'".$this->dbh->real_escape_string($objAccountHist->strAccName)."', ";
        $strQuery .= "'".$this->dbh->real_escape_string($objAccountHist->strAccLogin)."', ";
        $strQuery .= "'".$this->dbh->real_escape_string($objAccountHist->strAccUrl)."', ";
        $strQuery .= "'$objAccountHist->strAccPwd', ";
        $strQuery .= "'$objAccountHist->strAccMd5Pwd', ";
        $strQuery .= "'$objAccountHist->strAccIv', ";
        $strQuery .= "'".$this->dbh->real_escape_string($objAccountHist->strAccNotes)."', ";
