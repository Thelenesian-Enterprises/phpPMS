...
--
-- Servidor: localhost
-- Tiempo de generación: 21-05-2012 a las 20:48:49
...
--
CREATE DATABASE `phppms` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `phppms`;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `vacUserMPwd` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `vacUserMIv` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `datULastLogin` datetime DEFAULT NULL,
  `datULastUpdate` datetime DEFAULT NULL,
  ...
  `blnDisabled` tinyint(1) DEFAULT '0',
